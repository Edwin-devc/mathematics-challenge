                ...
                <table class="table text-nowrap mb-0 align-middle">
                    <thead class="text-dark fs-4">
                        <tr>
                            ...
                            <th class="border-bottom-0">
                                <h6 class="fw-semibold mb-0">School ID</h6>
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="border-bottom-0">
                                <p class="mb-0 fw-normal">{{ $representative->school_id }}</p>
                            </td>

                            <td class="border-bottom-0">
                                <p class="fw-bold mb-0 fs-4">
                                    <span class="mx-2 text-success" data-bs-toggle="modal" data-bs-target="#exampleModalview{{ $representative->representative_id }}">
                                        <i class="ti ti-eye"></i>
                                    </span>
                                </p>
                            </td>
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <p><span class="text-primary">School ID:
                                                </span>{{ $representative->school_id }}</p>
                                        </div>
