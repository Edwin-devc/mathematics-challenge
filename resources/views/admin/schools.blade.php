...
<div class="container-fluid">
    ...
    <div class="card w-100">
        <div class="card-body p-4">
            ...
            <button type="button" class="btn mtc-btn-primary text-white" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo"><span><i class="ti ti-plus"></i></span>
                        ...
                        <tr>
                            ...
                            <td class="border-bottom-0">
                                <p class="fw-bold mb-0 fs-4">
                                    <span class="mx-2 text-success" data-bs-toggle="modal" data-bs-target="#exampleModalview{{ $school->school_id }}">
                                        <i class="ti ti-eye"></i>
                                    </span>

                                    <span class="me-2 text-primary" data-bs-toggle="modal" data-bs-target="#exampleModaledit{{ $school->school_id }}" data-bs-whatever="@mdo">
                                        <i class="ti ti-edit"></i>
                                    </span>

                                    <span class="me-2 text-primary" data-bs-toggle="modal" data-bs-target="#exampleModaldelete{{ $school->school_id }}" data-bs-whatever="@mdo">
                            ...
                            <!-- view Modal -->
                            <div class="modal fade" id="exampleModalview{{ $school->school_id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h1 class="modal-title fs-5" id="exampleModalLabel{{ $school->school_id }}">School Details
                                            </h1>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body">
                            ...
                            {{-- edit form modal --}}
                            <div class="modal fade" id="exampleModaledit{{ $school->school_id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                                ...
                                                <div class="row g-3">
                                                    <div class="col-md-6">
                                                        <div class="form-floating">
                                                            <input type="text" class="form-control" id="name" name="name" placeholder="Name" value="{{ $school->name }}" required />
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-floating">
                                                            <input type="text" class="form-control" id="contact" name="district" value="{{ $school->district }}" placeholder="District" required />
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-floating">
                                                            <input type="text" class="form-control" id="registration_number" placeholder="Registration Number" name="registration_number" value="{{ $school->registration_number }}" required />
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-floating">
                                                            <input type="email" class="form-control" id="email" name="representative_email" placeholder="Email" value="{{ $school->representative_email }}" required />
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-floating">
                                                            <input type="text" class="form-control" id="representative_name" placeholder="Representative Name" name="representative_name" value="{{ $school->representative_name }}" required />
                            ...
                            {{-- delete modal --}}
                            <div class="modal fade" id="exampleModaldelete{{ $school->school_id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form action="{{ route('admin.schools.delete', ['school_id' => $school->school_id]) }}" method="POST" style="display:inline;" class="delete-form">
                                                @csrf
                                                @method('DELETE')
                                                <div class="modal-footer">
